...
class JeuBinaire:
    ...
    def draw(self):
        ...
        if self.etat == "binaire":
            ...
            pyxel.text(90, 110, "Appuie sur DEL pour rejouer travail.nsi.free.fr", 7)
    ...
    def draw_binaire(self):
        ...
        pyxel.text(10, 20, f"Lycee Jean Perrin NSI Nombre binaire : {self.binaire}", 7)
    ...
    def draw_shoot(self):
        pyxel.text(10, 10, "🚀 SHOOT 'EM UP Jean Perrin NSI ! SPACE = tir, ←/→ = bouger", 7)
